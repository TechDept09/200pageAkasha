...
import { buildCourseSchema, buildBreadcrumbSchema, buildFAQSchema, jsonLd } from '@/lib/seo';
import { FAQS } from '@/components/Faq80Meditation';
...
const courseSchema = buildCourseSchema({
  name: '80-Hour Meditation Teacher Training',
  description: tier.metaDescription,
  price: tier.promoPrice,
  category: 'Meditation',
...
const breadcrumbSchema = buildBreadcrumbSchema([
  ...
  { name: '80-Hour Meditation TTC', url: '/80h-meditation' },
]);
