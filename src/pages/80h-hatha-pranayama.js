...
import { buildCourseSchema, buildBreadcrumbSchema, jsonLd } from '@/lib/seo';
...
const courseSchema = buildCourseSchema({
  name: '80-Hour Advanced Hatha & Pranayama Teacher Training',
  description: tier.metaDescription,
  price: tier.promoPrice,
  category: 'Hatha & Pranayama',
...
const breadcrumbSchema = buildBreadcrumbSchema([
  ...
  { name: '80-Hour Hatha & Pranayama TTC', url: '/80h-hatha-pranayama' },
]);
  ...
  return (
    <TierProvider tier="80h-hatha-pranayama">
      <Head>
        ...
        {CanonicalLink('/80h-hatha-pranayama')}
