...
// Primary navigation. Dropdowns for 200-HR TTC (Essential + Premium)
// and Courses (the three 80-HR modules). 300-HR TTC is a single
// direct link because it only has one landing page.
const NAV = [
  {
    label: '200-HR TTC',
    dropdown: [
...
export default function HubNav() {
  ...
  // Small hover-close delay so the pointer can cross the gap between
  // the trigger and the dropdown panel without the panel snapping shut.
