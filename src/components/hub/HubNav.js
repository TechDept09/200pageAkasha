...
// Primary cross-page navigation. Dropdowns for 200-HR TTC (Essential
// and Premium) and Courses (three 80-HR modules); 300-HR TTC is a
// single direct link because it only has one landing page.
const NAV = [
  {
    label: '200-HR TTC',
    dropdown: [
