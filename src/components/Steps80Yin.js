// Section 17 from the live Wix 80-Hour Yin page: grey "2 STEPS TO GET
...
const STEPS = [
  {
    ...
    body: 'Sign up for a life-changing journey, and dive deep into the Heart of Yin Yoga.',
  },
  {
    n: '2',
    title: 'Begin the Journey That Will Transform Your Life',
    body: 'Experience how Yin Yoga can benefit all areas of life, and share your passion with others.',
  },
];

export default function Steps80Yin() {
  return (
