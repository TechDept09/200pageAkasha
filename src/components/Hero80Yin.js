...
// Hero from the live Wix 80-Hour Yin Yoga TTC page: looping background video,
// Yoga Alliance white badge, title + script subtitle, mint Enroll now CTA,
// and a full-bleed mint promo strip.
const MINT = '#75C8AE';

const VIDEO_SRC =
  'https://video.wixstatic.com/video/cd7168_ac443cf0083b47ce9eed5df7eb1d58eb/720p/mp4/file.mp4';

const POSTER =
  'https://static.wixstatic.com/media/cd7168_ac443cf0083b47ce9eed5df7eb1d58ebf000.jpg/v1/fill/w_1920,h_1080,al_c,q_85,enc_avif,quality_auto/poster.jpg';
...
export default function Hero80Yin() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative section flex flex-col items-center justify-center text-center pt-16 md:pt-24 pb-24 md:pb-28 min-h-[70vh] md:min-h-[76vh]">
        ...
        >
          Online 80-Hour Yin Yoga Teacher Training
        </h1>

        <p
          className="script text-akasha-white mt-4 md:mt-5"
          style={{ fontSize: 'clamp(1.6rem, 3.2vw, 2.5rem)', color: '#FFFFFF' }}
        >
