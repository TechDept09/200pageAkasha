// Section 19 from the live Wix 80-Hour Yin page: dark "START YOUR YIN YOGA
// JOURNEY NOW" promo band with tuition/bonuses math, 33% Summer Wellness
// Discount, US$399 offer, and mint ENROLL NOW CTA.
const MINT = '#75C8AE';
const ORANGE = '#E5771E';
...
export default function JourneyNow80Yin() {
  return (
    <section className="relative overflow-hidden" style={{ backgroundColor: DARK_BG }}>
      ...
      <div className="section relative z-10 py-14 md:py-20 text-center max-w-3xl mx-auto">
        ...
        <p className="font-body text-akasha-white/90 mt-4 text-base md:text-lg leading-relaxed">
          ...
          80-Hour Yin Yoga Online Teacher Training
        </p>
        ...
        >
          ...
          <p className="text-akasha-white">+5 Bonuses worth US$264</p>
          <p style={{ color: ORANGE }}>= Total Value US$864</p>
        </div>
