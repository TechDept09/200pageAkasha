// Section 21 from the live Wix 80-Hour Advanced Hatha & Pranayama page:
// grey FAQ teaser + "YOUR JOURNEY STARTS NOW" pricing close + orange
// DEEPEN YOUR YOGA NOW CTA.
const MINT = '#75C8AE';
...
const FAQ_URL =
  'https://www.akashayogaacademy.com/80-hr-online-ytt-hatha-pranayama-faq';
const ENROLL_URL =
...
export default function FaqJourney80Hatha() {
  return (
    <section className="relative overflow-hidden" style={{ backgroundColor: GREY_BG }}>
      ...
      <div className="section relative z-10 py-14 md:py-20 text-center">
        ...
        >
          <p>Are you ready to explore your commitment to Yoga like never before?</p>
          <p>The Akasha Family is here to guide you on every step of the way.</p>
        </div>
        ...
        <div className="mt-10">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center text-akasha-white uppercase tracking-[0.12em] px-8 md:px-10 py-3.5 font-body hover:shadow-lg transition-all text-center"
            style={{
