// Section 15 from the live Wix 80-Hour Meditation page: dark "START YOUR
// MEDITATION JOURNEY NOW" promo band with tuition/bonuses math, 33% Summer
// Wellness Discount, US$399 offer, and mint ENROLL NOW CTA.
const MINT = '#75C8AE';
const ORANGE = '#E5771E';
...
export default function JourneyNow80Meditation() {
  return (
    <section className="relative overflow-hidden" style={{ backgroundColor: DARK_BG }}>
      ...
      <div className="section relative z-10 py-14 md:py-20 text-center max-w-3xl mx-auto">
        ...
        >
          ...
          <p className="text-akasha-white">+7 Bonuses worth US$550</p>
          <p style={{ color: ORANGE }}>= Total Value US$1150</p>
        </div>
