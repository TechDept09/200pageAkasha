...
// Same primary nav as HubNav so the site header is consistent across
// the hub landing and every individual course page. Dropdowns for
// 200-HR TTC (Essential + Premium) and Courses (three 80-HR modules).
const NAV = [
  {
    label: '200-HR TTC',
    dropdown: [
