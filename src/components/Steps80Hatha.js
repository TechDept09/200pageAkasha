// Section 9 (cont.) from the live Wix 80-Hour Advanced Hatha & Pranayama page:
// "2 STEPS TO GET STARTED" with large orange numerals and mint ENROLL NOW.
const MINT = '#75C8AE';
const ORANGE = '#ED5829';
...
const STEPS = [
  {
    ...
    body: 'Sign up for a life-changing journey, and dive deep into the Heart of authentic Yoga.',
  },
  {
    n: '2',
    title: 'Begin a Life-Changing Journey Now',
    body: 'Experience how Yoga can benefit all areas of life & share your passion with others.',
  },
];

export default function Steps80Hatha() {
  return (
    <section className="relative overflow-hidden" style={{ backgroundColor: GREY_BG }}>
      ...
      <div className="relative py-6 md:py-8" style={{ backgroundColor: '#2A2A2A' }}>
