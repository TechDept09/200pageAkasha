...
const PATHS = [
  {
    title: 'Teach at Yoga Studios',
    body:
      'Walk into any yoga studio with a recognised credential. RYT-200 is the industry standard that studios look for when hiring teachers. Many of our graduates are teaching within weeks of completing the training.',
  },
  {
      ...
      <div className="section max-w-4xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-10">
          {PATHS.map((p) => (
            <article
              key={p.title}
              className="bg-akasha-gray-4/20 border border-akasha-gray-4 rounded-sm p-6 md:p-7 hover:bg-akasha-white hover:shadow-md hover:border-akasha-orange transition-all duration-300"
            >
              <h3
