...
export default function WhoIsThisFor() {
  return (
    <section
      className="py-14 md:py-20 bg-akasha-orange/5"
      ...
      <div className="section max-w-3xl">
        ...
        <ul className="space-y-3 md:space-y-4 mb-8">
          {SCENARIOS.map((s, i) => (
            <li
              key={i}
              className="flex items-start gap-4 bg-akasha-white border border-akasha-gray-4 border-l-4 border-l-akasha-orange rounded-sm px-5 md:px-6 py-4 md:py-5 hover:shadow-md transition-shadow duration-300"
            >
              <span
