...
export default function WhatIsYTT() {
  return (
    <section
      className="py-14 md:py-20 bg-akasha-gold/5"
      ...
      <div className="section max-w-4xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 mb-10 md:mb-12">
          {PILLARS.map((p) => (
            <article
              key={p.title}
              className="bg-akasha-white border border-akasha-gray-4 rounded-sm p-6 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-300"
            >
              <p
