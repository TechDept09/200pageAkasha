// Section 13 from the live Wix 80-Hour Yin page: "STUDY WITH THE BEST"
// copy, then "WE KNOW THIS IS A BIG STEP FOR YOU" with orange script,
// five platform ratings, and the 1100-instructors credibility lines.
...
export default function StudyBest80Yin() {
  return (
      ...
      <div className="section relative z-10 py-14 md:py-20">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="mt-8 md:mt-10 space-y-5 font-body" style={pStyle}>
            <p>
              Join our <B>trusted &amp; time-proven</B> training to deepen &amp;
              empower your own practice. And become a more competent &amp; confident
              Yoga Teacher on the way.
            </p>
            <p>
              This educational program delivers a <B>superb level of quality</B>,
              expertise &amp; excellence on all levels. We&rsquo;re here to support
              you on <em className="italic">every</em> step of your Yoga evolution.
            </p>
            <p>
              At Akasha, we put our heart &amp; soul into creating a{' '}
              <B>nurturing &amp; loving family</B> atmosphere. You will be guided by
              passionate &amp; dedicated senior teachers, who are Experienced
              Registered Yoga Teachers at the highest level (E-RYT 500).
            </p>
          </div>
        </div>
        ...
        <div className="mt-14 md:mt-16 text-center">
          ...
          <div className="mt-12 max-w-2xl mx-auto space-y-3 font-body" style={pStyle}>
            <p>
              ...
              <B>1100 awesome Yoga Instructors</B>
            </p>
            <p>
              &ndash; who are now successfully teaching on <B>all 6 continents</B>.
            </p>
            <p>
              Countless <B>genuine reviews</B> speak for themselves.
            </p>
          </div>
        </div>
      </div>
