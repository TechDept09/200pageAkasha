// Section 22 from the live Wix 80-Hour Meditation page: grey "THE AKASHA
// DIFFERENCE" icon list, orange lotus, mint JOIN THE AKASHA FAMILY CTA.
// Keep Wix typos ("mediation", "peer mediators").
const MINT = '#75C8AE';
...
const ITEMS = [
  {
    key: 'award',
    text: "The systematic course curriculum takes you all the way - from establishing a solid foundation in mediation to the most subtle experiences.",
...
<path d="M133.1 113.4l4.3-15.5 16.4-10.7-7-18.2 7-18.2L137.4 40l-5.1-18.8-19.3 1.1L98 10 83 22.3l-19.3-1.1L58.6 40 42.2 50.7l7 18.2-7 18.2 16.4 10.7 6.7 20.4L35 172.3l24.9-8.3 8 26 32.2-62.1 32.2 62.1 8-26 24.7 8.3-31.9-58.9zm-64.6 63.5l-5.9-18.8-16.9 5.6 25.7-46.9 2.1-.3 8.6-.5 12.6 9.9-26.2 51zm29.8-56.5l-13.1-9.6-.8-.8-11 .5-5.9.3-4.6-16.6-14.5-9.4 6.2-16.1-6.2-16.1 14.5-9.4 4.3-16.3 17.2.8L97.7 17l13.4 10.7 17.2-.8 4.6 16.6 14.5 9.4-6.2 16.1 6.2 16.1-14.5 9.4-4.6 16.6-17.2-1.1-12.8 10.4zm38.6 36.9l-5.9 18.8-27.3-53 9.4-7.5 15.8.8 25.2 46.9-17.2-6z" fill="#E5771E" data-color="1"/>
  ...
  {
    key: 'book',
    text: "Authentic teachings based on decades of committed research, study & practice.",
...
<path d="M116.3 114.4c.7 0 1.3-.2 1.9-.6 12.6-8.2 28.1-9 28.3-9 1.9-.1 3.4-1.7 3.3-3.6-.1-1.9-1.7-3.4-3.6-3.4-.7 0-17.6.8-31.8 10.1-1.6 1.1-2.1 3.2-1 4.8.6 1.2 1.8 1.7 2.9 1.7z" fill="#E5771E" data-color="1"/>
  ...
  {
    key: 'video',
    text: "Mental comprehension and actual experience of meditation go hand in hand.",
...
<path fill="#E5771E" d="M53.667 140.526v5.789H30.5v-5.789h23.167z" data-color="1"/>
  ...
  {
    key: 'camera',
    text: "Develop your teaching skills based on experience to share the practice with your community.",
...
<path fill="#E5771E" d="M167 136.667v5.867h-5.826v-5.867H167z" data-color="1"/>
  ...
  {
    key: 'people2',
    text: "Loving support and expert guidance from seasoned teachers.",
    svg: `<svg role="presentation" aria-hidden="true" preserveAspectRatio="xMidYMid meet" viewBox="21.843 32.157 156.313 135.686" xmlns="http://www.w3.org/2000/svg">
<g>
<path fill="#E5771E" d="M137.337 99.445c-14.252 0-26.578 4.431-33.854 11.295v-5.713c0-14.588-17.93-26.015-40.82-26.015s-40.82 11.427-40.82 26.015v39.729l10.668 1.106a291.66 291.66 0 0 0 30.049 1.549c9.792 0 19.589-.491 29.315-1.474l4.641-.469v19.719l10.613 1.102a291.794 291.794 0 0 0 30.097 1.554c9.778 0 19.559-.49 29.269-1.47l11.661-1.177v-39.737c.001-14.587-17.929-26.014-40.819-26.014zm-40.856 38.989l-5.309.536c-2.3.232-4.605.433-6.912.609v-25.966h-2.546v26.133a285.175 285.175 0 0 1-38.104.011v-26.144h-2.546v25.978a284.205 284.205 0 0 1-7.832-.695l-4.388-.454v-33.416c0-10.306 15.486-19.013 33.818-19.013S96.48 94.72 96.48 105.026v33.408zm74.674 20.432l-5.361.54c-2.283.231-4.57.429-6.859.604v-26.207h-2.546v26.375a285.343 285.343 0 0 1-38.104.012v-26.387h-2.546v26.221a280.505 280.505 0 0 1-7.887-.7l-4.333-.449v-33.416c0-10.306 15.486-19.012 33.818-19.012s33.818 8.706 33.818 19.012v33.407z" data-color="1"/>
<path fill="#E5771E" d="M137.337 94.011c11.447 0 20.76-9.312 20.76-20.76s-9.313-20.76-20.76-20.76-20.76 9.312-20.76 20.76 9.313 20.76 20.76 20.76zm0-34.517c7.586 0 13.758 6.172 13.758 13.758s-6.171 13.758-13.758 13.758-13.758-6.172-13.758-13.758 6.171-13.758 13.758-13.758z" data-color="1"/>
<path fill="#E5771E" d="M62.663 73.677c11.447 0 20.76-9.312 20.76-20.76s-9.313-20.76-20.76-20.76-20.76 9.312-20.76 20.76 9.313 20.76 20.76 20.76zm0-34.517c7.586 0 13.758 6.172 13.758 13.758S70.25 66.675 62.663 66.675s-13.758-6.172-13.758-13.758S55.077 39.16 62.663 39.16z" data-color="1"/>
</g>
</svg>`,
  },
  {
    key: 'globe',
    text: "Go in your own flow - study at your own pace. The pre-recorded course content allows for full flexibility & a personalized learning experience.",
...
<path d="M174.55 92.31c-2.623-.987-5.43-1.368-8.138-2.087a33.472 33.472 0 0 1-11.136-5.318c-1.369-1.002-2.707-2.131-4.332-2.618-2.479-.744-5.124.136-7.711.184-2.199.041-4.376-.526-6.576-.494-2.812.042-5.101 1.837-7.582 2.892-2.351 1-5.785 2.355-4.844 5.716.213.761.706 1.522.477 2.279-.194.644-.842 1.021-1.288 1.525-1.117 1.264-.883 3.186-.582 4.846.662 3.648 1.355 7.382 3.23 10.58 1.876 3.198 5.207 5.805 8.914 5.759 2.023-.025 3.958-.819 5.969-1.041 2.011-.222 4.379.356 5.245 2.184.783 1.651.04 3.588.073 5.416.075 4.104 4.087 7.697 3.168 11.697-.386 1.68-1.623 3.123-1.739 4.843-.062.922.208 1.831.489 2.711a91.818 91.818 0 0 0 7.085 16.446c15.127-14.461 24.6-34.799 24.728-57.379a80.705 80.705 0 0 0-.096-4.383c-1.298-1.744-3.29-2.981-5.354-3.758z" fill="#FFFFFF" data-color="2"/>
  ...
  {
    key: 'manual',
    text: "Contact your guides anytime through our course platform and get your questions answered.",
...
<path d="M114.906 110.093c-.198 0-.397-.031-.59-.096l-7.457-2.486 1.179-3.535 5.004 1.668v-6.01l-5 1.667-1.179-3.535 7.453-2.485a1.864 1.864 0 0 1 2.453 1.768v11.18a1.862 1.862 0 0 1-1.863 1.864z" fill="#E5771E" data-color="1"/>
  ...
  {
    key: 'people3',
    text: "Meet a vibrant community of peer mediators and Lead Teachers in occasional live calls.",
...
<path d="M153.456 94.317c-3.926-5.122-9.922-7.943-16.878-7.943h-12.117c4.984-10.908 5.154-26.807 1.188-36.237-2.887-6.862-7.829-10.638-13.919-10.638-1.652 0-3.381.29-5.14.855-8.689 2.802-9.015 9.724-9.303 15.83-.42 8.874-1.056 21.923-23.628 38.773v-8.465H42v72.826h31.66v-9.008c5.418 4.908 13.13 10.189 21.245 10.189h36.611c7.637 0 15.169-5.777 17.152-13.15l8.222-30.59c2.272-8.452 1.021-16.634-3.434-22.442zm-88.219 56.579H50.423V94.92h14.814v55.976zm83.517-36.324l-8.222 30.592c-.989 3.685-5.201 6.911-9.015 6.911H94.905c-7.958 0-17.306-9.198-21.245-13.896v-32.876c30.727-20.874 31.546-38.253 32.042-48.721.304-6.46.663-7.302 3.472-8.211.922-.297 1.784-.447 2.557-.447 2.555 0 4.622 1.844 6.152 5.48 4.2 9.986 2.012 27.905-4.183 34.236l-7.003 7.157h29.88c4.339 0 7.865 1.605 10.192 4.644 2.849 3.716 3.572 9.227 1.985 15.131z" fill="#E5771E" data-color="1"/>
  ...
  {
    key: 'book2',
    text: "Immediate access to your course - start anytime - start now!",
    svg: `<svg preserveAspectRatio="xMidYMid meet" viewBox="10.411 30.955 178.189 136.945" xmlns="http://www.w3.org/2000/svg" role="presentation" aria-hidden="true">
<g>
<path d="M188.3 68.4c0-5.9-1.5-10.2-4.4-12.6-2.6-2.2-5.5-2.2-6.6-2.1H169v-19c0-1.8-1.4-3.3-3.2-3.5C164 31 122.5 27.7 99 53 75.5 27.8 34 31.1 32.2 31.3c-1.8.2-3.2 1.7-3.2 3.5v17.4l-7-.3c-.8 0-4.1 0-7 2.8-3 2.9-4.4 7.5-4.3 13.8-.4 3.4-.3 12.2-.2 37.9.1 18.2.2 36.6.2 37.5 0 .9.1 6.5 4.4 10.9 3 3.1 7.3 4.7 12.6 4.7h43.1c.1 0 10.2.1 12.1 6 .5 1.5 1.8 2.4 3.3 2.4h12.6c.2 0 .4 0 .6-.1.2 0 .4.1.6.1h12.6c1.5 0 2.9-1 3.3-2.4 1.9-5.9 12-6 12.1-6h43.1c5.9 0 10.4-1.7 13.4-5 3.8-4.2 3.7-9.4 3.6-10.6 0-1.9.1-19.7.2-37.4.4-26 .4-34.7 0-38.1zM162 38.1v91c-23.5-3.8-48.6 9.5-59.5 16.3V59.7c17.4-20.8 49.3-21.8 59.5-21.6zm-126 0c10.2-.2 42.1.8 59.5 21.5v85.8c-4-2.5-9.9-5.8-16.9-8.9-12.3-5.4-23.7-8.1-34-8.1-3 0-5.8.2-8.6.7v-91zM14.9 71.9c-.2 0-.4.1-.7.1.2-.1.4-.1.7-.1zm.1-.1c.2 0 .3-.1.5-.2-.2.1-.3.2-.5.2zm.7-.2c.1-.1.3-.1.4-.2-.2.1-.3.1-.4.2zm.5-.3c.2-.1.3-.2.4-.4-.1.1-.2.3-.4.4zm.5-.4c.2-.2.3-.4.5-.6-.2.2-.3.4-.5.6zm.8-1.4c-.1.2-.2.5-.3.7.1-.2.2-.4.3-.7zm163.9 74.8s.3 3.3-1.8 5.5c-1.6 1.8-4.4 2.7-8.2 2.7h-43.1c-.5 0-13.1 0-17.8 8.5h-10.4c-.2 0-.4 0-.6.1-.2 0-.4-.1-.6-.1H88.5c-4.7-8.5-17.2-8.5-17.7-8.5H27.7c-3.4 0-5.9-.8-7.6-2.5-2.4-2.4-2.4-6-2.4-6v-.1c-.2-28-.4-70.4-.1-74.7.1-.3.1-.6.1-.9-.1-4 .6-7 2-8.4.8-.8 1.7-1 2-1l7.3.3v74.2c0 1.1.5 2.1 1.4 2.8.9.7 2 .9 3 .6 14.7-3.8 31.1 1.2 42.3 6.1 12.4 5.4 21.2 11.9 21.3 11.9.1.1.3.2.4.2.2.1.4.2.7.2h.2c.2 0 .5.1.7.1s.5 0 .7-.1h.2c.2-.1.5-.1.7-.3h.1c.1-.1.3-.2.4-.2.1-.1 9-6.5 21.3-11.9 11.2-4.9 27.5-9.9 42.3-6.1 1 .3 2.2 0 3-.6.9-.7 1.4-1.7 1.4-2.8V60.7h9.2c.2 0 .8 0 1.4.5.6.5 1.9 2.2 1.9 7.2 0 .3 0 .5.1.8.3 4.3.1 46.8-.1 74.7-.3.2-.2.3-.2.4zm.1-74.7c.1.3.3.7.5.9-.2-.3-.4-.6-.5-.9zm.6 1l.3.3-.3-.3zm1.6 1.1c-.1 0-.2-.1-.3-.1.1.1.2.1.3.1zm-.5-.2c-.1-.1-.2-.1-.3-.2.1.1.2.2.3.2zm-.4-.3c-.1-.1-.2-.1-.3-.2.1.1.2.2.3.2zm1.2.6c.1 0 .2 0 .3.1-.1 0-.2-.1-.3-.1z" fill="#E5771E" data-color="1"/>
<path d="M50.2 69.6c.2 0 15.7.8 28.3 9 .6.4 1.3.6 1.9.6 1.1 0 2.3-.6 2.9-1.6 1.1-1.6.6-3.8-1-4.8C68 63.5 51.2 62.7 50.5 62.7c-1.9-.1-3.6 1.4-3.6 3.3-.1 1.9 1.4 3.5 3.3 3.6z" fill="#E5771E" data-color="1"/>
...
export default function AkashaDifference80Meditation() {
  return (
