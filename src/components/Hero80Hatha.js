...
// Hero from the live Wix 80-Hour Advanced Hatha & Pranayama TTC page:
// looping background video, Yoga Alliance white badge, title + subtitle,
// mint Join Now CTA, and a full-bleed mint promo strip.
const MINT = '#75C8AE';
...
export default function Hero80Hatha() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative section flex flex-col items-center justify-center text-center pt-16 md:pt-24 pb-24 md:pb-28 min-h-[70vh] md:min-h-[76vh]">
        ...
        <h1
          ...
          style={{
            fontSize: 'clamp(1.45rem, 3.8vw, 2.85rem)',
            fontWeight: 400,
            letterSpacing: '0.02em',
            maxWidth: '22ch',
          }}
        >
          80-Hour Advanced Hatha &amp; Pranayama Online TTC
        </h1>
