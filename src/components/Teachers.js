...
export default function Teachers() {
  return (
    <section id="teachers" className="relative bg-transparent">
      {/* Mandala backdrop moved to PromoLanding as a fixed page-wide
          layer so it stays pinned in the viewport across every
          section, not just this one. Section keeps its own layout,
          transparent so the fixed mandala shows through. */}
