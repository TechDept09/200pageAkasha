...
export const courses = [
...

  {
    ...
    tagline: 'From Teacher to Master Teacher',
    discountPercent: 78,
    regularPrice: 1800,
    promoPrice: 399,
    currency: 'USD',
    ...
    inclusions: [
      ...
      '300-hour Yoga Alliance certification credential',
      'Ten bonuses (valued at $503): meditation collection, silent retreat access, music playlists, posters, scripture study',
...

  {
    ...
    tagline: 'Stillness as a Doorway',
    discountPercent: 33,
    regularPrice: 600,
    promoPrice: 399,
    currency: 'USD',
    ...
    inclusions: [
      ...
      'Five bonus materials: Pranayama Masterclass, Breath-Based Alignment Workshop, Yin Yoga Sequences guide, high-resolution teaching poster, curated music collection',
...

  {
    ...
    tagline: 'Breath as the Foundation',
    discountPercent: 33,
    regularPrice: 600,
    promoPrice: 399,
    currency: 'USD',
    ...
    inclusions: [
      ...
      'Seven bonus resources: 8 Limbs workshop, resume template, meditation collection, liability waiver, cover letter guide, client intake form, annual planner',
...

  {
    ...
    tagline: 'Many Lineages, One Heart',
    discountPercent: 33,
    regularPrice: 600,
    promoPrice: 399,
    currency: 'USD',
...

  {
    ...
    tagline: 'A Pilgrimage to the Ganga',
    discountPercent: 40,
    regularPrice: 2999,
    promoPrice: 1799,
    currency: 'USD',
