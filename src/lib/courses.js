...
export const courses = [
...

  {
    ...
    // July pricelist: Premium at regular US$1,490 (no discount).
    // 6-month plan stays at US$249/month.
    discountPercent: 0,
    discountLabel: null,
    saleEndShort: null,
    regularPrice: 1490,
...

  {
    ...
    // July pricelist: Feminine Wisdom at regular US$229 (no discount).
    discountPercent: 0,
    discountLabel: null,
    saleEndShort: null,
    regularPrice: 229,
...

  {
    ...
    // July pricelist: 30% off, US$1,999 (was US$2,999). 3-month
    // plan US$699/month = US$2,097 total.
    discountPercent: 30,
    discountLabel: '30% Transform Discount',
    saleEndShort: SALE_END_SHORT,
    regularPrice: 2999,
    promoPrice: 1999,
    currency: 'USD',
